...
argument-hint: "<what you want to measure or analyze>"
metadata:
  author: rhino-health
  version: "0.2.0"
---
...
1. **Metrics Reference** — `${CLAUDE_SKILL_DIR}/references/metrics_reference.md`
...
5. **See also** — point to a matching example from `${CLAUDE_SKILL_DIR}/references/examples/INDEX.md` if one exists

## Working Examples

Check `${CLAUDE_SKILL_DIR}/references/examples/INDEX.md` for matching examples. Key ones for metrics:
