...
argument-hint: "[question about the SDK]"
metadata:
  author: rhino-health
  version: "0.2.0"
---
...
Check `${CLAUDE_SKILL_DIR}/references/examples/INDEX.md` for a matching working example. When one exists, reference it by filename and describe which pattern it demonstrates. Read the example file to verify details before citing it.
