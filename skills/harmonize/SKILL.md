...
argument-hint: "<what you want to harmonize or transform>"
metadata:
  author: rhino-health
  version: "0.2.0"
---
...
Check `${CLAUDE_SKILL_DIR}/references/examples/INDEX.md` for matching examples. The key harmonization example is:

- **`fhir_pipeline.py`** — end-to-end: data harmonization, FHIR resource generation, CSV export. Read the full file at `${CLAUDE_SKILL_DIR}/references/examples/fhir_pipeline.py` when relevant.
