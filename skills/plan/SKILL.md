...
argument-hint: "<high-level goal or research question>"
metadata:
  author: rhino-health
  version: "0.2.0"
---
...
Check `${CLAUDE_SKILL_DIR}/references/examples/INDEX.md` for working examples that demonstrate individual templates:
